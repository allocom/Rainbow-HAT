...
PACKAGE_NAME = u"Rainbow HAT"
PACKAGE_HANDLE = "RainbowHAT"
PACKAGE_MODULE = "rainbowhat"

if hasattr(rainbowhat,"__version__"):
    PACKAGE_VERSION = rainbowhat.__version__
else:
